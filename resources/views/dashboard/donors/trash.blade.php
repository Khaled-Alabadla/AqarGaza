...
@section('title', 'عرض الجهات المانحة المحذوفة')
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الجهات المانحة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    قائمة الجهات المانحة المحذوفة</span>
            </div>
        </div>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">الجهات المانحة المحذوفة</h4>
                                    ...
                                    <tr>
                                        ...
                                        @if (auth()->user()->can('donors.restore') || auth()->user()->can('donors.force_delete'))
                                            <td>
                                                ...
                                                @can('donors.force_delete')
                                                    <a class="btn btn-danger-gradient btn-sm" data-target="#modaldemo1"
                                                        data-toggle="modal" href="" data-id="{{ $donor->id }}">حذف
                                                        نهائي</a>
                                                @endcan
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        {{-- <h6>Modal Body</h6> --}}
                        <p>هل أنت متأكد من عملية حذف الجهة المانحة بشكل نهائي؟</p>
                    </div>
...
@section('js')
    ...
    <script>
        $('#modaldemo1').on('show.bs.modal', function(event) {
            ...
            var modal = $(this);
            modal.find('form').attr('action', '/donors/' + donorId + '/force-delete');
        });
    </script>
@endsection
