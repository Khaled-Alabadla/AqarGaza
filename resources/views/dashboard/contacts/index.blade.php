                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">وقت الإرسال</th>
                                    @if (auth()->user()->can('contacts.show') || auth()->user()->can('contacts.delete'))
                            ...
                            <tbody>
                                @foreach ($messages as $message)
                                    <tr style="{{ !$message->is_open ? 'background: rgb(235, 230, 230)' : '' }}">
                                        ...
                                        @if (auth()->user()->can('messages.show') || auth()->user()->can('messages.delete'))
                                            <td>
                                                @can('messages.show')
                                                    <a href="{{ route('dashboard.contact_messages.show', $message->id) }}"
                                                        class="btn btn-primary-gradient btn-sm"> عرض</i></a>
                                                @endcan
