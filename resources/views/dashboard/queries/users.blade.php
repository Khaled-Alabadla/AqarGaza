...
@section('title', ' الاستعلامات والتقارير عن المستخدمين')
    ...
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الاستعلامات والتقارير</h4><span
                class="text-muted mt-1 tx-13 mr-2 mb-0">/ المستخدمين
            </span>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ URL::current() }}" method="GET">
                        ...
                        <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                            ...
                            <select class="form-control select2" name="user">
                                ...
                                @foreach ($users as $user)
                                    <option value="{{ $user->id }}" @selected(request()->query('user') == $user->id)>
                                        {{ $user->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-sm-6 col-md-3 m-auto mb-5">
                        <button class="btn btn-primary btn-block">عرض العقارات </button>
                    </div>
                </form>
