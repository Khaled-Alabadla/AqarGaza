...
//     const customFileUploadText = document.querySelector('.custom-file-input span');
...
//     const mainFileUploadText = document.querySelector('#main-property-image + span'); // Selector for the span next to the main image input
//     const mainUploadButton = document.querySelector('#main-property-image ~ .upload-btn'); // Selector for the button next to the main image input // Simulate click on hidden main property image input when its custom button is clicked
